...
def main():
    ...
    parser.add_argument('--vae_device', type=str, default="cpu", help="Device to load VAE on (e.g. 'cpu' to save GPU VRAM)")
    ...
    if args.vae_device == "cpu":
        pipe.vae.to("cpu")
        print("VAE successfully offloaded to CPU to save GPU memory.")
    ...
    with open(metadata_path, 'r') as file:
        for line in file:
            ...
            # If VAE is on CPU, it runs VAE decoding on CPU. The generated output is a PIL image
